...
public class ObservacoesMedicasRepository implements IObservacoesMedicasRepository  {
        ...
        public List<ObservacoesMedicas> findAll() {
            return entityManager.createQuery("select s from Recepcionista s ORDER BY s. nome", ObservacoesMedicas.class).getResultList();
        }
    ...
    public void update(int id, ObservacoesMedicas observacoesMedicas) {
        ...
        observacoesMedicasInDb.setPaciente(observacoesMedicas.getPaciente());
        observacoesMedicasInDb.setMedico(observacoesMedicas.getMedico());
